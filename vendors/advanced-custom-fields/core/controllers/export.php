...
<p><?php _e("Plugins will create a .xml export file which is compatible with the native WP import plugin.",'acf'); ?></p>
...
<p><?php _e("Plugins will create the PHP code to include in your theme.",'acf'); ?></p>
...
<p><?php _e("The Advanced Custom Fields plugin can be included within a theme. To do so, move the Plugins plugin inside your theme and add the following code to your functions.php file:",'acf'); ?></p>

<pre>
include_once('advanced-custom-fields/acf.php');
</pre>

<p><?php _e("To remove all visual interfaces from the Plugins plugin, you can use a constant to enable lite mode. Add the following code to your functions.php file <b>before</b> the include_once code:",'acf'); ?></p>
