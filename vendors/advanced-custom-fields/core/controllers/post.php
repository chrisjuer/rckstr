...
*  acf_controller_post
*
*  This class contains the functionality to add Plugins fields to a post edit form
*
*  @type	class
*  @date	5/09/13
*  @since	3.1.8
...
class acf_controller_post
{
	...
	*/
	...
	function admin_head()
	{
		...
		// remove Plugins from meta postbox
	...
	*
	*  This action will allow Plugins to render metaboxes after the title
	*
	*  @type	action
	*  @date	17/08/13
	*
...
(function($) {
	...
	*/
	...
	{	
		...
		// this would imply that the user is hooking into an Plugins update_value or save_post action and inserting a new post
	...
	*  is_protected_meta
	*
	*  This function will remove any Plugins meta from showing in the meta postbox
	*
	*  @type	function
	*  @date	12/04/2014
	*  @since	5.0.0
