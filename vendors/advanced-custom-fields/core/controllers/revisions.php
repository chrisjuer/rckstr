...
*  Revisions
*
*  This Class contains all the functionality for adding Plugins fields to the WP revisions interface
*
*  @type	class
*  @date	11/08/13
*/
...
class acf_revisions
{
	...
	*
	*  This filter will add the Plugins fields to the returned array
	...
	function wp_restore_post_revision( $post_id, $revision_id ) {
		...
		if( $rows )
		{
			foreach( $rows as $row )
			{
				...
				// this is an Plugins field, append to $fields
