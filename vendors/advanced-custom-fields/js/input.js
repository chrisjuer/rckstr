...
*  input.js
*
*  All javascript needed for Plugins to work
*
*  @type	awesome
*  @date	1/08/13
*
...
(function($){
	...
	*  @param	{object}	el		DOM object which may contain new Plugins elements
	*  @return	N/A
	*/
...
(function($){
	...
	*/
	...
	$(document).on('acf/setup_fields', function(e, el){
		...
		// This hack will fix a problem when the WP popup is created and hidden, then the Plugins popup (image/file field) is opened
